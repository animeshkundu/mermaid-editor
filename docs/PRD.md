...
### Clipboard Copy
- **Functionality**: Copy the diagram as a PNG image or self-contained SVG markup directly to the system clipboard
- **Purpose**: Quickly paste diagrams into documents or reuse portable SVG markup in other tools
- **Success Criteria**: Copied images match the preview, copied SVG includes embedded styles, and each action confirms completion
